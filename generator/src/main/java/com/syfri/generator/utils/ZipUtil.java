...
public class ZipUtil {
     ...
     * @param response
     * @param src 路径 （包含.zip）
     * @param fileName 文件名 （包含.zip）
     */
    public static void download(HttpServletRequest request, HttpServletResponse response,String src,String fileName){
        ...
        try {
            ...
            if(ext=="docx") {
                ...
                response.setContentType("application/zip");// zip格式
            }
