(function() {
	...
	SideToolbar.prototype = {
		initView: function() {
			var toolbar = '<div class="side-toolbar"><a id="sideToolbar-btn" href="javascript:void(0);"></a><a id="sideToolbar-up" href="javascript:void(0)"></a><a id="sideToolbar-fullscreen" href="javascript:void(0)"></a><a id="sideToolbar-export" href="javascript:void(0)" onclick="exportDoc()"></a></div>';
