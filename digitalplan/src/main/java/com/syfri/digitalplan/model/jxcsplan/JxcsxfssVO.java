...
public class JxcsxfssVO extends ValueObject implements Serializable{
	...
	private String xfsslxmc;	//消防设施类型
	...
	public String getXfsslxmc() {
		return xfsslxmc;
	}

	public void setXfsslxmc(String xfsslxmc) {
		this.xfsslxmc = xfsslxmc;
	}
}